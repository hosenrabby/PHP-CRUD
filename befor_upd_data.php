    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-12 g-0">
                ...
                <h3 class="display-6 text-center">Befor UpDated Data Information</h3>
            </div>
        </div>
        <div class="row">
            ...
            ?>
                <table class="table table-light table-hover text-center">
                    ...
                    <tbody>
                    <?php
                        $query = $dbconnect->query("SELECT * FROM `befor_upd_data`");
                        $x=1;
                        if ($query) {
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?=$sdata['email']?></td>
                            <td>
                                <a class="btn btn-outline-danger btn-sm" href="delete.php?befrDelete=<?=$sdata['id']?>"><i class="fa-solid fa-trash-can"></i> PERMANENTLY DELETE</a>
                            </td>
                        </tr>
                    <?php 
                            }
